...
Page Head
===========================================-->
    <div class="blog-main-slider color-white text-center" style="background-image:url('assets/img/b16.jpg'); no-repeat">
...
===========================================-->
    ...
    <div class="container">
        <div class="row">
                <div class="order-success" id = "success">
                <div class="col-lg-12">
                <h2>Transaction Success. ID -  <span id="invoiceID" ></span> </h2>
               
                <h2>YOUR ORDER HAS BEEN RECEIVED.
                 <span class="back-home"><button type="button" class="button" title="Back to homepage" onclick="window.location='index.jsp'"><span>Back to Hompage</span></button></span></h2>
                <strong class="msg">Thank you for your purchase!</strong>
                <p>You will receive an order confirmation email to <span class="email">mail@gmail.com</span> with details of your order and a link to track its progress.
                </p>
                </div>
                </div>
                
                <div class="order-success" id = "failed">
                <div class="col-lg-12" >
                <h2  style="color:#FF0000">Transaction Declined. ID -  <span id="invoiceID1" ></span>
                <span class="back-home"><button type="button" class="button" title="Back to homepage" onclick="window.location='index.jsp'"><span>Back to Hompage</span></button></span></h2>
                </div>
                </div>
                ...
                <span class="print"><i class="fa fa-print"></i> Print</span>
                <div class="your-order">
                    <h3 class="checkbox-title">order summary</h3>
                            ...
                            <table>
                                ...
                                <tfoot>
                                    ...
                                    <tr class="order-total">
                                        <th>Total</th>
                                        <td>
                                            <strong><span class="amount" id="totalAmount" >฿${htotal}.00</span></strong>
                                        </td>
                                    </tr>                               
                                </tfoot>
                             </table>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var uuid = GetURLParameter('uuid');
		 ...
		 $.ajax({
			  url: "getStatus.do?uuid="+uuid,
			  type: "post",
			  data: "",
			  contentType: "application/json",
			  dataType: 'json',
			  success: function(json) {
				  console.log(json.staus);   // needs to match the payload (i.e. json must have {value: "foo"}
				  console.log(json.invoiceId);  
				   document.getElementById("invoiceID").innerHTML = json.invoiceId;
				   document.getElementById("invoiceID1").innerHTML = json.invoiceId;
				 $('#'+json.staus).show();
				},
			  error:function(){
			     $('#failed').show();
