        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="checkbox-form">
                    <h3 class="checkbox-title">your shipping address</h3>
                        <div class="row">
                                <div class="col-md-12">
                        ...
                        <div class="your-order-table table-responsive">
                            ...
                            <div class="payment-method">
                                <div class="order-button-payment">
                                   <input type="submit" value="IKTB Pay" onclick="btnClick();">   <input type="submit" value="Place order" onclick="btnClick();">
                                </div>
                            </div>                          
                </div><!--your-order-->
            </div><!--col-->  
...
<script type="text/javascript">
		  ...
		  function btnClick() {
			  ...
			  window.location = "PayProcess.do?p="+totalAmount+"&s=<%= session.getAttribute("user")%>" ; 
		  }
  </script>
