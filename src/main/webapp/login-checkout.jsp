        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="checkbox-form login">
                    <h3 class="checkbox-title">Login details</h3>
                        <div class="row">
						 ...
						 <% } else {%>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="cbox_info">
                                        <p>Create an account by entering the email below. If you are a returning customer please login at the top of the page.</p>
                                        <p class="form-row">
                                ...
                                <div class="col-md-12">
                                    <button class="btn btn-send btn-pink" onclick="btnclick();" >SUBMIT</button>
                                </div>   
                        ...
                        <div class="your-order-table table-responsive">
                            ...
                            <div class="payment-method">
                                <div class="order-button-payment">
                                    <input type="submit" value="Continue" onclick="window.location='checkout.jsp'">
                                </div>
                            </div>                          
                </div><!--your-order-->
            </div><!--col-->  
